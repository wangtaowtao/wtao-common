...
import static com.eyaoshun.common.util.StringUtil.lineToHump;
	...
	public static void generator(
		...
		for (int i = 0; i < 3; i++) {
			...
			if (i == 0) {
				...
				t = "t_contract_attachment";
			}
			String model = StringUtil.lineToHump(ObjectUtils.toString(t));
